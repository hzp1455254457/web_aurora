...
## Purpose
AI女友web官网项目，提供AI女友交互界面和用户体验。项目专注于构建高性能、现代化的前端官网应用，支持AI女友的实时交互、多媒体展示和用户交互功能。
...
## Domain Context
- **AI女友**：项目核心是AI驱动的虚拟女友交互系统
- **实时交互**：需要支持实时音视频交互、表情动作同步、情感交流
- **多媒体处理**：涉及音频、视频、3D模型等多媒体内容
- **用户体验**：注重流畅的交互体验和视觉呈现，营造温馨浪漫的氛围
